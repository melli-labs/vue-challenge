  ...
  <div class="bg-primary-50 min-h-screen grid items-center">
    <div class="grid place-items-center gap-12">
      ...
      >
        ...
        >
          <img class="max-w-xs ml-auto" src="/emilia.svg">
          <div class="absolute w-full bottom-0 left-0 p-3">
            <Transition
              appear
              class="transition delay-300 duration-600"
              enter-from-class="opacity-0 translate-y-10"
            >
              <div
                class="text-center text-lg text-white bg-black bg-opacity-80 mx-auto max-w-md p-2 rounded"
              >
                {{ text }}
              </div>
            </Transition>
